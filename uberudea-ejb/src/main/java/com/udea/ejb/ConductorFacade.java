...
public class ConductorFacade extends AbstractFacade<Conductor> implements ConductorFacadeLocal {
    ...
    @PersistenceContext(unitName = "com.udea_uberudea-ejb_ejb_1.0-SNAPSHOTPU")
    ...
    @Override
    public boolean doesCedulaExist(String cedula) {
        Query query = em.createNamedQuery("Conductor.findByCedula");
